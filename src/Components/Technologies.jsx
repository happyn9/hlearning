      ...
      >
        ...
        <div style={{ padding: "24px 24px 0" }}>
          ...
          <div style={{ display: "flex", gap: 6, marginBottom: 20 }}>
            {[`${levels.length} niveaux`, `${totalCourses} cours`].map((label) => (
  ...
  return (
    ...
    >
      <div style={{
        ...
        color: isActive ? p.accent : "#D1D5DB",
        transition: "color 0.2s", paddingLeft: 4,
      }}>
        {p.number}
      </div>
      ...
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 5 }}>
          <span style={{
            ...
            color: isActive ? p.accentText : "#9CA3AF",
            transition: "all 0.2s",
          }}>
            {p.tag}
          </span>
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        gap: 0, minHeight: "100vh",
      }}>

        {/* Left */}
        <div style={{ padding: "80px 56px 80px 0", borderRight: "1px solid #F3F4F6" }}>
          <motion.div
        ...
        >
          <div style={{ marginBottom: 36 }}>
            {[
              { value: "6", labelKey: "technology.stat.programs" },
              { value: "4", labelKey: "technology.stat.levels" },
              { value: "100%", labelKey: "technology.stat.online" },
            ].map((s, i) => (
              <motion.div
                key={s.labelKey}
              ...
              >
                ...
                <div style={{ fontSize: 11, color: "#9CA3AF", fontWeight: 500, letterSpacing: "0.03em" }}>
                  {/* Fallback text if key not in translations yet */}
                  {i === 0 ? (t("technology.stat.programs") || "Programmes disponibles")
                    : i === 1 ? (t("technology.stat.levels") || "Niveaux par programme")
                    : (t("technology.stat.online") || "Formation en ligne")}
                </div>
              </motion.div>
            ))}
          </div>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 5 }}>
                  {Object.values(curriculum[activeId]).flat().slice(0, 5).map((c) => (
                    <span key={c} style={{
                      ...
                      color: activeProgram.accentText, fontWeight: 500,
                    }}>
                      {c}
                    </span>
                  ))}
                  {Object.values(curriculum[activeId]).flat().length > 5 && (
                    <span style={{
                      ...
                      color: activeProgram.accentText, opacity: 0.7, fontWeight: 500,
                    }}>
                      +{Object.values(curriculum[activeId]).flat().length - 5}
                    </span>
                  )}
          ...
          <div>
            ...
            <p style={{ fontSize: 11, color: "#9CA3AF", marginTop: 12, lineHeight: 1.6, textAlign: "center" }}>
              {t("tuition.cards.pdf.desc") ? "" : "Accès immédiat · Certificat reconnu"}
            </p>
          </div>
        </motion.div>
      </div>

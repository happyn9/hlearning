...
export default function Footer({ showfaq = true }) {
  ...
  trigger(async (setProgress) => {
    ...
    await changeLanguage(lang); // IMPORTANT await
    ...
    <div className="bg-[#F9FAFB]">
      ...
      {showfaq && (
        <section className="pb-20 pt-2 max-w-5xl mx-auto px-6">
          <h1 className="text-center pt-3 pb-8 text-slate-800 font-bold text-3xl">{t("footer.faqTitle")}</h1>
      ...
      <footer className="bg-neutral-950 text-gray-400">
        ...
        <div className="max-w-7xl mx-auto px-6 py-24">
          ...
          <div className="grid md:grid-cols-5 gap-14">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-500 max-w-sm leading-relaxed">
                Empowering learners worldwide with structured,
                industry-aligned academic programs and certifications.
              </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-sm">
            ...
            <span>
              © {new Date().getFullYear()} h-learning Inc.{" "}
              {t("footer.copyright")}
            </span>

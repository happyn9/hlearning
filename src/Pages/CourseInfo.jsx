...
export default function CourseInfo() {
  ...
  /* ================= PHONE INPUT ================= */
  // Ne garde que des chiffres et tronque à la longueur locale attendue
  // (le code opérateur de 3 chiffres est géré séparément, voir OPERATORS).
  const handlePhoneChange = (rawValue) => {
    const digitsOnly = rawValue.replace(/\D/g, "").slice(0, PHONE_LOCAL_LENGTH);
    setPhone(digitsOnly);
  };
  ...
  const handleSubscribe = async () => {
    ...
    // ex: code="097" + phone="1234567" -> "0971234567" (10 chiffres, valide cote backend)
      ...
      <div className="max-w-6xl mx-auto px-6 mt-16 grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <div className="bg-[#1a1c1f] border border-slate-800 rounded-2xl p-8 shadow-xl">
            <div className="flex items-center gap-3 mb-6">
              <BookOpen size={20} />
              <h3 className="text-xl font-semibold text-white">What You Will Learn</h3>
            </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-[#1a1c1f] border border-slate-800 rounded-2xl p-6 shadow-xl">
            <div className="flex items-center gap-2 mb-4">
              <BarChart3 size={18} />
              <h4 className="font-semibold text-white">Course Overview</h4>
            </div>
          ...
          <div className="bg-[#1a1c1f] border border-slate-800 rounded-2xl p-6 shadow-xl">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Connect with other learners, ask questions and share your progress inside
              ...
              <div className="flex justify-between items-center px-8 py-6 border-b border-slate-800">
                <div className="flex flex-col">
                  ...
                  <p className="text-sm text-slate-400 mt-1 flex items-center gap-2">
                    ...
                    Secure mobile payment via Flutterwave
                  </p>
                </div>
              ...
              <div className="grid md:grid-cols-2">
                ...
                <div className="p-8 border-r border-slate-800 bg-[#15171b] flex flex-col justify-between">
                  ...
                  <div className="mt-6 text-xs text-slate-500 text-center">
                    🔒 Payments are encrypted and processed securely via Flutterwave
                  </div>
                </div>
...
function MobileMoneyPaymentForm({
  ...
  const selected = OPERATORS.find((op) => op.id === operator);
  ...
  return (
    <div className="bg-white rounded-xl p-6 text-gray-800 shadow-md">
      <h3 className="text-sm font-semibold text-gray-600 mb-4">MOBILE MONEY PAYMENT</h3>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">{phone.length}/7 digits</p>
        </div>

        {/* INFO */}
        <p className="text-xs text-gray-500">
          A payment request will be sent to your phone. Confirm the payment on your
          mobile device.
        </p>

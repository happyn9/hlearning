...
define(['./workbox-eef98954'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(({
    url
  }) => url.pathname.startsWith("/api/pay/") || url.pathname.startsWith("/api/auth/") || url.pathname.startsWith("/api/otp"), new workbox.NetworkOnly(), 'GET');
  workbox.registerRoute(({
    url,
    request
